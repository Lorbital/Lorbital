...
(function () {
  ...
  var en = {
    ...
    explorer: {
      ...
      introText: 'This page provides 3D point-cloud visualizations of hydrogen atom orbitals. Hydrogen is the simplest atomic system whose Schr\u00f6dinger equation can be solved exactly, yielding the orbital wave functions for electrons in various quantum states. These models are computed by solving the hydrogen atom Schr\u00f6dinger equation, generated in Python via Monte Carlo rejection sampling based on the probability density |ψ|², so that the point density accurately reflects the probability of finding the electron at each location around the nucleus. The page also includes DFT results for dodecahedral and icosahedral representative molecules: starting from ideal cage geometries, the structures are geometry-optimized and then exported as layered total-electron-density and HOMO point clouds. Use the entries below to open the periodic table, g orbitals, or cage models.',
